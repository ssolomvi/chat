...
import ru.mai.chat.common.encryption_algorithm.impl.*;
...
import static ru.mai.chat.common.utils.Operations.byteArrEqual;
import static ru.mai.chat.common.utils.Operations.filesAreEqual;
...
public class EncryptionDecryptionTests {
    ...
    void testEncryptionModes() {
        ...
        EncryptionMode[] modes = new EncryptionMode[7];
        ...
        for (EncryptionAlgorithm algorithm : algorithms) {
            for (EncryptionModeEnum encryption : EncryptionModeEnum.values()) {
                for (PaddingModeEnum padding : PaddingModeEnum.values()) {
                    ...
                    if (encryption == EncryptionModeEnum.ECB) {
...
//        algorithms[6] = new LOKI97(key32);
    ...
    void simpleContextTestPaths() {
        ...
        EncryptionService context = new SymmetricEncryptionServiceImpl(EncryptionModeEnum.ECB, PaddingModeEnum.ZEROES, des);
    ...
    void contextWithConfigurationsTestByteArr(EncryptionModeEnum modeEnum, PaddingModeEnum paddingModeEnum,
        ...
        EncryptionService context = new SymmetricEncryptionServiceImpl(modeEnum, paddingModeEnum, algorithm, initVector);
    ...
    void paddingMultipleTest() {
        PaddingMode[] modes = new PaddingMode[4];
        int blockSize = 16;
