package ru.mai.chat.common.encryption_context;
...
import ru.mai.chat.common.encryption_mode.abstr.EncryptionModePreviousNeeded;
import ru.mai.chat.common.encryption_mode.abstr.EncryptionModeWithInitVector;
import ru.mai.chat.common.encryption_mode.impl.*;
import ru.mai.chat.common.encryption_padding_mode.PaddingMode;
import ru.mai.chat.common.encryption_padding_mode.impl.ANSI_X_923;
import ru.mai.chat.common.encryption_padding_mode.impl.ISO10126;
import ru.mai.chat.common.encryption_padding_mode.impl.PKCS7;
import ru.mai.chat.common.encryption_padding_mode.impl.Zeroes;
import ru.mai.chat.common.exceptions.IllegalArgumentExceptionWithLog;
import ru.mai.chat.common.exceptions.IllegalMethodCallException;
...
public class SymmetricEncryptionServiceImpl implements EncryptionService {
    private static final Logger log = LoggerFactory.getLogger(SymmetricEncryptionServiceImpl.class);
    ...
    public SymmetricEncryptionServiceImpl(ru.mai.chat.common.EncryptionModeEnum encryptionModeEnum, ru.mai.chat.common.PaddingModeEnum paddingModeEnum, EncryptionAlgorithm algorithm) {
        ...
        if (encryptionModeEnum != ru.mai.chat.common.EncryptionModeEnum.ECB) {
            throw new IllegalArgumentExceptionWithLog(String.format("Encryption mode %s needs initial vector", encryptionModeEnum.getDescriptorForType().getName()), log);
        }
    ...
    public SymmetricEncryptionServiceImpl(EncryptionModeEnum encryptionModeEnum, ru.mai.chat.common.PaddingModeEnum paddingModeEnum, EncryptionAlgorithm algorithm, byte[] initializationVector) {
        if (paddingModeEnum == null) {
            throw new IllegalArgumentExceptionWithLog("Passed param paddingModeEnum is null", log);
        }
        if (encryptionModeEnum == null) {
        ...
        if (encryptionModeEnum != EncryptionModeEnum.ECB && initializationVector == null) {
            throw new IllegalArgumentExceptionWithLog(String.format("Encryption mode %s needs initial vector", encryptionModeEnum.getDescriptorForType().getName()), log);
        }
